  ...
  def new_user_reaction
    ...
    respond_to do |format|
      ...
      if reaction_article || reaction_comment
        format.html { redirect_to article_path(@article), notice: "Ya ha reaccionado a este artículo" }
      else
        ...
        if @reaction.save!
          format.html { redirect_to article_path(@article), notice: "Reacción exitosamente creada" }
        else
